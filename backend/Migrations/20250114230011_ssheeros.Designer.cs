...
namespace Backend.Migrations
{
    ...
    [Migration("20250114230011_ssheeros")]
    partial class ssheeros
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Entities.AI.AIConversation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.AI.AIMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.SSHCommand", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.SSHHostConfig", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.SSHSession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.UserPreferences", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.Entities.AI.AIConversation", b =>
                {
                    b.HasOne("Backend.Models.Entities.SSH.SSHSession", "LinkedSSHSession")
            ...
            modelBuilder.Entity("Backend.Models.Entities.AI.AIMessage", b =>
                {
                    b.HasOne("Backend.Models.Entities.AI.AIConversation", "AIConversation")
                        .WithMany("AIMessages")
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.SSHCommand", b =>
                {
                    b.HasOne("Backend.Models.Entities.SSH.SSHSession", "SSHSession")
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.SSHSession", b =>
                {
                    b.HasOne("Backend.Models.Entities.SSH.SSHHostConfig", "SSHHostConfig")
            ...
            modelBuilder.Entity("Backend.Models.Entities.SSH.UserPreferences", b =>
                {
                    b.HasOne("Backend.Models.Entities.SSH.SSHHostConfig", "DefaultSSHHost")
                    ...
                    b.HasOne("Backend.Models.AppUser", "User")
                        ...
                        .HasForeignKey("Backend.Models.Entities.SSH.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
